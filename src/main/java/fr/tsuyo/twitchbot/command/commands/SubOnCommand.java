...
public class SubOnCommand implements ICommand {
    ...
    public void run(ChannelMessageEvent event, String[] args) {
        ...
        new TwitchCRequest().setSubscriber(true).send_patch();
        chat.sendMessage(channel, "/me Activation du mode réservé aux abonnés.");
    }
    ...
    public List<String> aliases() {
        return Collections.singletonList("son");
    }
}